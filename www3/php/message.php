...
//        $mail->_SMTPSecure = 'ssl';
       ...
       $msgsubject  = "Message from the customer ({$cmpdate})";
        $msgbrd = "<hr />
        <table border=0 cellspacing=3 cellpadding=6>
        <caption style=\"color:#5050f0\"><b><i>MESAJ TƏFƏRRÜATLARI:</i></b></caption>
        <tr bgcolor=\"#eeeeff\"><td bgcolor=\"#eeeeff\">Ad: </td><td><b>$msgname</b> </td></tr>
        <tr><td>Email: </td><td><b>$msgemail</b> </td></tr>
        <tr bgcolor=\"#eeeeff\"><td bgcolor=\"#eeeeff\">Rəy: </td><td><div style=\"padding:5px;\">$msgcomment</div></td></tr>
        </table>
        <hr />
            ";
